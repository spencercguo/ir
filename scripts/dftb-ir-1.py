...
def main():
    dipoles = []
    # file1 = '../sherlock/dftb_files/dftb-dipole-data/traj_select_frames-dftb_dipole-1.data'
    # file2 = '../sherlock/dftb_files/dftb-dipole-data/traj_select_frames-dftb_dipole-2.data'
    # file3 = '../sherlock/dftb_files/dftb-dipole-data/traj_select_frames-dftb_dipole-3.data'

    # read_dipole_data(file1, dipoles, 63000)
    # read_dipole_data(file2, dipoles)
    # read_dipole_data(file3, dipoles)

    read_dipole_data('../sherlock/dftb_files/dftb-dipole-data/traj_select_frames-dftb_dipole-test-2.data', dipoles)

    dipoles = np.array(dipoles)
    dipoles = dipoles.transpose()

    dipole_autocorrelations = ir.autocorrelation(dipoles)
    plt.plot(dipole_autocorrelations)
    plt.show()
